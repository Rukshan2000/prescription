...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <ul>
        <li><a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded-md">Dashboard</a></li>
        <li><a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded-md">Orders</a></li>
        <li><a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded-md">Rejected Orders</a></li>
        <li><a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded-md">Settings</a></li>
    </ul>
</div>
